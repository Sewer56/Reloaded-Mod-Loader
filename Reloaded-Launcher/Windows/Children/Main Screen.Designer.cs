...
namespace ReloadedLauncher.Windows.Children
{
    partial class Main_Screen
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.box_VersionBox = new ReloadedLauncher.Styles.Controls.Animated.AnimatedButton();
            this.box_PictureBox = new ReloadedLauncher.Styles.Controls.Animated.AnimatedButton();
            this.box_GameList = new ReloadedLauncher.Styles.Controls.Animated.AnimatedDataGridView();
            this.modName = new System.Windows.Forms.DataGridViewTextBoxColumn();
            this.modDirectory = new System.Windows.Forms.DataGridViewTextBoxColumn();
            this.box_GameListBox = new ReloadedLauncher.Styles.Controls.Animated.AnimatedButton();
            this.box_NoteBox = new ReloadedLauncher.Styles.Controls.Animated.AnimatedButton();
            this.box_LocationBox = new ReloadedLauncher.Styles.Controls.Animated.AnimatedButton();
            this.item_GameBanner = new System.Windows.Forms.PictureBox();
            this.item_InjectionBoxInjection = new ReloadedLauncher.Styles.Controls.EnhancedLabel();
            this.item_VersionBoxVersion = new ReloadedLauncher.Styles.Controls.EnhancedLabel();
            this.item_NoteBoxVerPath = new ReloadedLauncher.Styles.Controls.EnhancedLabel();
            this.item_NoteBoxEXEPath = new ReloadedLauncher.Styles.Controls.EnhancedLabel();
            this.item_NoteBoxVERTitle = new ReloadedLauncher.Styles.Controls.EnhancedLabel();
            this.item_NoteBoxEXETitle = new ReloadedLauncher.Styles.Controls.EnhancedLabel();
            this.item_NoteBoxGameName = new ReloadedLauncher.Styles.Controls.EnhancedLabel();
            this.item_NoteBoxSeparator = new ReloadedLauncher.Styles.Controls.EnhancedLabel();
            this.item_LocationBoxEXEPath = new ReloadedLauncher.Styles.Controls.EnhancedLabel();
            this.item_LocationBoxDirectoryPath = new ReloadedLauncher.Styles.Controls.EnhancedLabel();
            this.item_LocationBoxDirectoryTitle = new ReloadedLauncher.Styles.Controls.EnhancedLabel();
            this.item_LocationBoxEXETitle = new ReloadedLauncher.Styles.Controls.EnhancedLabel();
        ...
        private Styles.Controls.EnhancedLabel item_InjectionBoxInjection;
