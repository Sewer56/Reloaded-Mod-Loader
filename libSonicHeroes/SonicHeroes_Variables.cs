...
namespace SonicHeroes.Variables
{
    ...
    public static class SonicHeroesVariables
    {
        ...
        /// <summary>
        /// Pointers to currently loaded ingame objects. You may wish to manipulate them as you may need from here.
        /// </summary>
        public enum Game_Objects_CurrentlyLoaded
        {
            /// <summary>
            /// [IntPtr] Address representing the start of a pointer table for currently loaded rings.
            /// </summary>
            Table_Rings = 0x009CE888,
        }

        /// <summary>
        /// Offsets for Ring addresses obtained from Game_Objects_CurrentlyLoaded.Table_Rings
        /// </summary>
        public enum Game_Objects_CurrentlyLoaded_Table_Rings_Offsets
        {
            /// <summary>
            /// [Float] Offset to Ring's X Position.
            /// </summary>
            X_Position = 0x90,
            /// <summary>
            /// [Float] Offset to Ring's Y Position.
            /// </summary>
            Y_Position = 0x94,
            /// <summary>
