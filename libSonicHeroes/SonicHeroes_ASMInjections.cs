...
namespace SonicHeroes.ASMInjections
{
    /// <summary>
    /// This class defines fun assembly injections which you may perform to alter the state of the game and game flow.
    /// </summary>
