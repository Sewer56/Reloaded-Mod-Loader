...
namespace Reloaded.Process.Functions.X64Hooking
{
    ...
    public class X64FunctionHook<TFunction>
    {
        ...
        {
            // Patch all addresses
            Reloaded.Memory.Sources.Memory.Current.SafeWrite(_hookToWrite.Item1, ref _hookToWrite.Item2);

            // Apply all patches.
            foreach (var addressToPatch in _addressesToPatch)
            { Reloaded.Memory.Sources.Memory.Current.SafeWriteRaw(addressToPatch.Item1, addressToPatch.Item2); }
