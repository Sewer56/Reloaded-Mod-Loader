...
namespace Reloaded.Process.Buffers
{
    ...
    public class MemoryBuffer
    {
        ...
        public unsafe MemoryBuffer(IntPtr bufferAddress, uint bufferSize, bool isBufferPreallocated = false)
        {
            ...
            VirtualQueryEx(ReloadedProcess.FromCurrentProcess().ProcessHandle, bufferAddress, out memoryInformation, (uint)sizeof(MEMORY_BASIC_INFORMATION));
            ...
            if (memoryInformation.State != PageState.Free && !isBufferPreallocated)
            {
                ...
                MemoryBufferHeader bufferHeader = Reloaded.Memory.Sources.Memory.Current.SafeRead<MemoryBufferHeader>(BaseBufferAddress);
            ...
            else
            {
                if (! isBufferPreallocated)
                {
                    ...
                    (
                        ReloadedProcess.FromCurrentProcess().ProcessHandle,
                        BaseBufferAddress,
                        bufferSize,
                ...
                Reloaded.Memory.Sources.Memory.Current.SafeWrite(BaseBufferAddress, ref BufferHeader);
            }
        }
        ...
        public IntPtr Add(byte[] bytesToWrite)
        {
            ...
            BufferHeader = Reloaded.Memory.Sources.Memory.Current.SafeRead<MemoryBufferHeader>(BaseBufferAddress);
            ...
            Reloaded.Memory.Sources.Memory.Current.SafeWriteRaw(appendAddress, bytesToWrite);
