...
namespace Reloaded.Process.Buffers
{
    ...
    public static class MemoryBufferManager
    {
        ...
        /// <summary>
        /// Scans the currently targeted process in <see cref="ReloadedProcess.FromCurrentProcess"/> for any buffers
        ...
        public static List<MemoryBuffer> GetBuffers(int size = 0)
        {
            ...
            var memoryBasicInformation = ReloadedProcess.FromCurrentProcess().GetPages();
        ...
        public static IntPtr Add(byte[] bytesToWrite)
        {
            ...
            if (buffers.Count < 1)
            {
                ...
                // Create new buffer.
                var memoryPageSet = ReloadedProcess.FromCurrentProcess().GetPages();
        ...
        {
            return Add(Struct.GetBytes(ref bytesToWrite), targetAddress);
        }
        ...
        private static bool IsBuffer(IntPtr address)
        {
            try
            {
                ...
                MemoryBufferHeader bufferHeader = Reloaded.Memory.Sources.Memory.Current.SafeRead<MemoryBufferHeader>(address);
