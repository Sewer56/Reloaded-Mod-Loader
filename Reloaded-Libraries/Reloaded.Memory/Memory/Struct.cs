...
namespace Reloaded.Memory
{
    ...
    public static unsafe class Struct
    {
        ...
        /// <param name="pointer">The address where to read the struct from.</param>
        /// <param name="marshalElement">Set to true to marshal the element.</param>
        public static T FromPtr<T>(IntPtr pointer, bool marshalElement = false) => FromPtr(pointer, Source.Read<T>, marshalElement);
        ...
        public static T FromPtr<T>(IntPtr pointer, MemoryExtensions.ReadFunction<T> readFunction, bool marshalElement = false) => readFunction(pointer, marshalElement);
        ...
        public static T FromArray<T>(byte[] data, int startIndex = 0, bool marshalElement = false)
        {
            ...
            {
                return FromPtr((IntPtr)(&dataPtr[startIndex]), _thisProcessMemory.Read<T>, marshalElement);
            }
        }
