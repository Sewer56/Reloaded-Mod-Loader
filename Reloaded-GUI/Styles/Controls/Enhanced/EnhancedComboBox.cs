...
namespace Reloaded_GUI.Styles.Controls.Enhanced
{
    public class EnhancedComboBox : ComboBox, IBorderedControl
    {
        ...
        public Color DropDownArrowColour
        {
            ...
            set { dropDownArrowColor = value; _arrowBrush = new SolidBrush(DropDownArrowColour); Invalidate(); }
        }
        ...
        protected override void WndProc(ref Message m)
        {
            ...
            if (m.Msg == WM_PAINT)
            {
                ...
                Rectangle dropDownRectangle = new Rectangle(Width - WidthOfDropbutton, 0, WidthOfDropbutton, Height);
        ...
        private void DrawArrow(Graphics graphics)
        {
            ...
            // Fill the arrow
            graphics.FillPath(_arrowBrush, arrowPath);
        }
