...
namespace ReloadedUpdateChecker.Updaters.Implementations.Github
{
    public class GithubUpdater : IUpdateSource
    {
        /// <summary>
        ...
        */
        ...
        /// </summary>
        private List<Update> ProcessReleases(List<QueueItemReleasePair> itemReleasePairs)
        {
            List<Update> updates = new List<Update>(itemReleasePairs.Count);
            ...
            {
                Update update = itemReleasePair.GetUpdate();
                if (update != null)
                    updates.Add(update);
            }
