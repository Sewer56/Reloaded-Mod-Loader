...
namespace Reloaded_GUI.Styles.Controls.Enhanced
{
    ...
    public class EnhancedButton : Button, IControlIgnorable, IDecorationBox
    {
        ...
        protected override void OnPaint(PaintEventArgs paintArguments)
        {
            ...
            if (string.IsNullOrEmpty(Text) && !string.IsNullOrEmpty(_customText))
            {
                ...
                // Paint our text
                paintArguments.Graphics.DrawString(_customText, Font, new SolidBrush(ForeColor), ClientRectangle, stringFormat);
            }
        }
