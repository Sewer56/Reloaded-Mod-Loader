...
{
    /// <summary>
    /// An alternative variation of <see cref="FixedArrayPtr{TStruct}"/> that can be used for
    ...
    /// </typeparam>
    public unsafe class FixedArrayPtrExternal<TStruct> : ICloneable, IEnumerable<TStruct> where TStruct : struct
    {
        /// <summary>
        ...
        public FixedArrayPtrExternal(ref TStruct value, int count) : this(count)
        {
        ...
        /// <param name="count">The amount of elements in the array structure in memory.</param>
        /// <remarks>See <see cref="FixedArrayPtr{T}"/></remarks>
        public FixedArrayPtrExternal(ulong address, int count) : this(count)
        {
        ...
        /// <param name="count">The amount of elements in the array structure in memory.</param>
        /// <remarks>See <see cref="FixedArrayPtr{T}"/></remarks>
        public FixedArrayPtrExternal(IntPtr address, int count) : this(count)
        {
        ...
        /// complete array size.
        /// </summary>
        private FixedArrayPtrExternal(int count)
        {
            Count = count;
        ...
        private class FixedArrayPtrEnumerator : IEnumerator<TStruct>
        {
            ...
            /// </summary>
            private readonly FixedArrayPtrExternal<TStruct> _arrayPtr;
            ...
            public FixedArrayPtrEnumerator(FixedArrayPtrExternal<TStruct> parentArrayPtr)
            {
