...
{
    /*
        Shamelessly stolen from my own old Heroes Tweakbox. 
    */
    ...
    struct AdventurePhysics
    {
        ...
        public float UnknownIii;
        public float UnknownIv;
